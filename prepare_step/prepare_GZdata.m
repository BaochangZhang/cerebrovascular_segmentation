function [ImageT,Iout,TempVessel] = prepare_GZdata(Image_path,brainMask_path,Empirical_value)
...
% [ImageT,Iout,TempVessel] = prepare_GZdata(Image_path,brainMask_path,Empirical_value)
% Input:
...
%   load data(original image and brain mask)    
    ...
    ImageT(ImageT==0)=prctile(Image(Image_edge>0),95)*1.5;
